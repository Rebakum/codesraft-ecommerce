                        ...
                        <form action="">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="col-span-full md:col-span-1">
                                    <label htmlFor="phone" className="text-sm"></label>
                                    <input id="phone" type="text" placeholder="Template cooking" className="w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600" />
                                </div>
                                <div className="col-span-full md:col-span-1">
