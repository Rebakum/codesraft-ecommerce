...
const HomeServices = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-6 bg-white shadow-md rounded-2xl border border-red-100">
      {services.map((s) => {
        const Icon = s.icon;
        return (
          <div key={s.title} className="flex items-center gap-3">
            <div className="shrink-0 w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center">
              <Icon className="text-red-700 text-lg" />
            </div>
